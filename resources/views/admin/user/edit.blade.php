    ...
    <div class="content-user">
        ...
        <div class="content-group">
            <div class="default-width">
                <div>
                    ...
                    <input class="form-control" type="text" placeholder="" id="username" name="username" value="{{ $user->username }}">
                    @error('username')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
                ...
                <div class="mt-30">
                    ...
                    <input class="form-control" type="email" placeholder="" id="email" name="email" value="{{ $user->email }}">
                    @error('email')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
        ...
        <div class="content-group">
            ...
            <div class="default-width">
                ...
                <div class="relative">
                    <input class="form-control" type="date" placeholder="" id="dayOfJoin" name="dayOfJoin" value="{{ $user->dayOfJoin }}">
                    <div class="tk-icon">
            ...
            <div class="default-width">
                ...
                <div class="relative">
                    <select class="form-control" id="level" name="level">
                        ...
                        <option value="{{ $item->id }}" {{ $user->level == $item->id ? 'selected' : '' }}>
                            {{ $item->name }}
                        </option>
                        @endforeach
                    </select>
