                    ...
                    <div class="content-user">
                        ...
                        <div class="content-group">
                            <div class="default-width">
                                <div>
                                    ...
                                    <input class="form-control" type="text" placeholder="" id="username" name="username" readonly
                                        value="{{ $user->username }}">
                                    @error('username')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="mt-30">
                                    ...
                                    <input class="form-control" type="email" placeholder="" id="email" name="email" readonly
                                        value="{{ $user->email }}">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                        ...
                        <div class="content-group">
                            <div class="default-width">
                                ...
                                <input class="form-control" type="password" placeholder="●●●●●●●●" id="password" readonly
                                    name="password">
                                @error('password')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="default-width">
                                ...
                                <div class="relative">
                                    <input class="form-control" type="date" placeholder="" id="dayOfBirth"
                        ...
                        <div class="content-group">
                            ...
                            <div class="default-width">
                                ...
                                <div class="relative">
                                    <input class="form-control" type="date" placeholder="" id="dayOfJoin" name="dayOfJoin" readonly
