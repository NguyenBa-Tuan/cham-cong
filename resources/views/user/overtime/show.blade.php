...
@section('page')
    <div class="container">
        <div class="dropdown">
            <input class="text-box" type="text" placeholder="Select month" readonly>
            <div class="options">
                @foreach($monthList as $monthItem)
                    <div class="items">
                        <a href="{{route('user_overtime_show', $monthItem->collect)}}"
        ...
        <a href="{{route('user_overtime_create')}}">Create overtime sheet</a>
    </div>
@endsection
